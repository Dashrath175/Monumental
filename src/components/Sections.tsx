...
export function Hero() {
  ...
  return (
    <section id="top" className="paper-surface paper-fibers relative overflow-hidden pt-24 md:pt-28">
      ...
      <div className="relative mx-auto max-w-[min(92vw,2200px)] w-full px-5 md:px-10 2xl:px-16">
        <div className="flex flex-wrap items-center justify-between gap-3 font-mono2 text-[10px] uppercase tracking-[0.3em] text-[#4A4743] 2xl:text-xs">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[1.25fr_0.75fr] lg:gap-8 2xl:gap-14">
          {/* TITLE */}
          <div className="relative">
            <p className="font-hand text-2xl text-[#4A4743] md:text-3xl 2xl:text-4xl">
              <span className="inline-block -rotate-2">psst — tilt your pencil flat</span>
              <SquiggleArrow className="ml-2 inline-block h-8 w-20 2xl:h-10 2xl:w-24 -scale-x-100 text-[#1A1918]" />
            </p>
            <h1 className="roughen mt-2 font-display uppercase leading-[0.82] tracking-tight">
              <span className="graphite-rub block text-[19vw] md:text-[11.5vw] lg:text-[clamp(4.5rem,7.8vw,11rem)] 2xl:text-[clamp(6rem,8.2vw,14rem)]">Anatomy</span>
              <span className="flex items-center gap-4 text-[8vw] md:text-[4.5vw] lg:text-[clamp(1.8rem,3.2vw,4.5rem)] 2xl:text-[clamp(2.4rem,3.4vw,5.5rem)]">
                ...
                <span className="font-mono2 text-[10px] tracking-[0.35em] text-[#4A4743] md:text-xs 2xl:text-sm">FIG.A — FRICTION STUDY</span>
              </span>
              <span className="graphite-rub block text-[19vw] md:text-[11.5vw] lg:text-[clamp(4.5rem,7.8vw,11rem)] 2xl:text-[clamp(6rem,8.2vw,14rem)]">Stroke<span className="text-[#1A1918]">.</span></span>
            </h1>

            <div className="mt-6 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
              <p className="max-w-[440px] 2xl:max-w-[620px] font-hand text-[22px] leading-[1.25] text-[#2C2A29] md:text-2xl 2xl:text-3xl">
              ...
              <div className="flex items-center gap-4">
                <a href="#gesture" data-cursor="drag" onClick={() => graphiteAudio.tap("pencil")} className="group relative inline-flex items-center gap-3 bg-[#1A1918] px-7 py-4 2xl:px-9 2xl:py-5 font-mono2 text-[11px] 2xl:text-xs uppercase tracking-[0.25em] text-[#F5F2EB]">
                  <span>Begin the rub</span>
                  <span className="transition-transform group-hover:translate-y-1">↓</span>
                  <span className="absolute -right-2 -top-2 h-4 w-4 rotate-12 bg-[#E8E3D7] shadow" />
                </a>
                <StarDoodle className="h-10 w-10 2xl:h-12 2xl:w-12 animate-wobble text-[#1A1918]" />
              </div>
            </div>

            {/* telemetry strip */}
            <div className="mt-8 grid grid-cols-3 divide-x divide-[#1A1918]/15 border-y border-[#1A1918]/20 font-mono2 text-[10px] 2xl:text-xs uppercase tracking-[0.2em] text-[#4A4743]">
              {[
                ["Lead", "6B — 9B carpenter"],
                ["Tooth", "cold-press · deep"],
                ["Gesture", "broad-side drag"],
              ].map(([k, v]) => (
                <div key={k} className="flex flex-col gap-1 px-4 py-3 2xl:px-6 2xl:py-4">
          ...
          <div className="relative mx-auto w-full max-w-[420px] lg:max-w-none" style={{ transform: `translateY(${y * -0.04}px)` }}>
            <div className="relative border border-[#1A1918]/25 bg-white/40 p-3 2xl:p-4 shadow-[8px_10px_0_rgba(26,25,24,0.12)]">
              ...
              <div className="relative overflow-hidden bg-[#FBFAF6]">
                <img src="/images/body-scribble.png" alt="Scribble figure reaching" className="h-[440px] w-full object-cover object-top md:h-[560px] 2xl:h-[720px] 3xl:h-[820px]" style={{ mixBlendMode: "multiply" }} />
              ...
              <div className="flex items-center justify-between px-1 pb-1 pt-3">
                <p className="font-mono2 text-[10px] 2xl:text-xs uppercase tracking-[0.25em] text-[#4A4743]">Fig. A — the spasm before form</p>
                <p className="font-hand text-lg 2xl:text-xl leading-none text-[#1A1918]">nervous lines!</p>
              </div>
            </div>
            {/* marginalia */}
            <div className="absolute -left-10 top-16 hidden -rotate-12 md:block">
              <p className="font-scribble text-[11px] 2xl:text-xs text-[#2C2A29]">don't press<br />too hard here</p>
            ...
            <div className="absolute -right-4 bottom-24 hidden rotate-6 md:block">
              ...
              <p className="mt-1 font-hand text-lg 2xl:text-xl leading-tight">scroll = stroke ↓</p>
            </div>
            {/* pressure badge */}
            <div className="absolute -bottom-6 left-6 flex rotate-[-3deg] items-center gap-3 border border-[#1A1918] bg-[#F5F2EB] px-4 py-2 2xl:px-6 2xl:py-3 shadow-[4px_4px_0_#1A1918]">
              ...
              <span className="font-mono2 text-[10px] 2xl:text-xs uppercase tracking-[0.25em]">live graphite · 94% friction</span>
            </div>
          </div>
        </div>
      </div>
...
export function Manifesto() {
  const ref = useReveal();
  return (
    <section className="paper-surface relative px-5 py-20 md:px-10 md:py-28 2xl:py-36">
      <div ref={ref} className="reveal-mask mx-auto max-w-4xl 2xl:max-w-6xl 3xl:max-w-7xl text-center">
        <p className="font-mono2 text-[10px] uppercase tracking-[0.4em] text-[#4A4743] 2xl:text-xs">— the thesis · read with dirty fingers —</p>
        <p className="mt-6 font-serif2 text-3xl leading-snug text-[#1A1918] md:text-5xl md:leading-tight 2xl:text-6xl 3xl:text-7xl">
          “Scrolling is not <em className="font-hand text-4xl md:text-6xl 2xl:text-7xl 3xl:text-8xl">scrolling</em> here. It is an invisible{" "}
        ...
        <div className="mt-8 flex items-center justify-center gap-6 font-hand text-xl text-[#4A4743] 2xl:text-2xl">
          <span className="flex items-center gap-2"><StarDoodle className="h-5 w-5 2xl:h-7 2xl:w-7" /> fig. 002</span>
          <span className="h-px w-24 2xl:w-36 bg-[#1A1918]/30" />
...
export function Chapter01() {
  ...
  return (
    <section id="gesture" className="paper-surface relative border-t-2 border-[#1A1918]">
      <div className="mx-auto max-w-[min(92vw,2200px)] w-full px-5 py-16 md:px-10 md:py-24 2xl:px-16 2xl:py-32">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            <p className="font-mono2 text-[11px] uppercase tracking-[0.4em] text-[#4A4743] 2xl:text-xs">Chapter 01 — The initial friction</p>
            <h2 className="roughen mt-3 font-display uppercase leading-[0.85]">
              <span className="block text-[15vw] md:text-[8vw] 2xl:text-[clamp(5rem,7.5vw,11rem)]"><span className="graphite-rub">01. The</span></span>
              <span className="block text-[15vw] md:text-[8vw] 2xl:text-[clamp(5rem,7.5vw,11rem)]"><span className="graphite-rub">Gesture</span><span className="font-hand ml-4 align-middle text-[6vw] normal-case text-[#4A4743] md:text-[2.5vw] 2xl:text-[3rem]">(reach!)</span></span>
            </h2>
          </div>
          <div className="max-w-xs 2xl:max-w-sm -rotate-2 border border-[#1A1918]/30 bg-white/50 p-4 2xl:p-6 shadow-[5px_5px_0_rgba(26,25,24,0.15)]">
            <p className="font-hand text-xl 2xl:text-2xl leading-tight text-[#2C2A29]">keep scrolling — watch the hand <b>get fat</b> with tone ↓</p>
          </div>
        </div>

        <div ref={ref} className="mt-12 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] 2xl:gap-16">
          {/* STICKY VISUAL */}
          <div className="lg:sticky lg:top-20 lg:self-start">
            <div className="relative border-2 border-[#1A1918] bg-[#FBFAF6] shadow-[10px_12px_0_rgba(26,25,24,0.9)]">
              <div className="flex items-center justify-between border-b-2 border-[#1A1918] px-4 py-2 font-mono2 text-[10px] uppercase tracking-[0.25em] 2xl:text-xs">
              ...
              <div className="relative overflow-hidden" data-cursor="smudge">
                <img
                  ...
                  className="img-shade h-[420px] w-full object-cover md:h-[600px] 2xl:h-[760px] 3xl:h-[860px]"
                  style={{
              ...
              <div className="flex items-center justify-between px-4 py-2 font-mono2 text-[10px] uppercase tracking-[0.2em] text-[#4A4743] 2xl:text-xs">
                <span>lead: flat 8B · tilt 42°</span>
                <span>tone: {Math.round(p * 100)}%</span>
              </div>
            </div>
            <div className="mt-4 flex items-center gap-3 font-scribble text-[11px] 2xl:text-xs text-[#2C2A29]">
              <SquiggleArrow flip className="h-8 w-20 2xl:h-10 2xl:w-24 -scale-y-100" />
          ...
          <div className="flex flex-col gap-8 lg:pb-24">
            {[
              ...
              <article key={s.n} className={`relative border border-[#1A1918]/25 bg-white/45 p-6 transition-all duration-500 md:p-8 2xl:p-10 ${stage === i ? "shadow-[8px_8px_0_#1A1918] -rotate-1" : "opacity-70"}`}>
                <div className="flex items-center justify-between">
                  <span className="bg-[#1A1918] px-3 py-1 font-mono2 text-[10px] uppercase tracking-[0.3em] text-[#F5F2EB] 2xl:text-xs">{s.n}</span>
                  <span className={`font-mono2 text-[10px] uppercase tracking-[0.25em] 2xl:text-xs ${stage === i ? "text-[#1A1918]" : "text-[#4A4743]/50"}`}>{stage === i ? "● laying tone" : "○ waiting"}</span>
                </div>
                <h3 className="mt-4 font-display text-3xl uppercase md:text-4xl 2xl:text-5xl">{s.t}</h3>
                <p className="mt-3 font-hand text-[22px] leading-[1.3] text-[#2C2A29] 2xl:text-[26px]">{s.d}</p>
                <p className="mt-4 inline-block rotate-1 bg-[#E8E3D7] px-3 py-1 font-hand text-lg 2xl:text-xl text-[#4A4743]">✎ {s.note}</p>
                {i === 2 && (
                  <div className="mt-5 border-t border-dashed border-[#1A1918]/30 pt-4">
                    <p className="font-hand text-xl 2xl:text-2xl leading-snug">“…coax mass out of the white <span className="hand-circle font-bold">silence ☺<CircleScribble className="text-[#1A1918]" /></span>.”</p>
                  </div>
                )}
              </article>
            ))}
            <div className="flex items-center gap-4 pl-2">
              <StarDoodle className="h-8 w-8 2xl:h-10 2xl:w-10 animate-spin-slow text-[#1A1918]" />
              <p className="font-mono2 text-[10px] uppercase tracking-[0.3em] text-[#4A4743] 2xl:text-xs">end of gesture · wipe your hands</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section id="cellular" className="paper-surface paper-fibers relative overflow-hidden border-t-2 border-[#1A1918]">
      ...
      <div className="mx-auto max-w-[min(92vw,2200px)] w-full px-5 py-16 md:px-10 md:py-24 2xl:px-16 2xl:py-32">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            <p className="font-mono2 text-[11px] uppercase tracking-[0.4em] text-[#4A4743] 2xl:text-xs">Chapter 02 — Botanical equilibrium</p>
            <h2 className="roughen mt-3 font-display uppercase leading-[0.85]">
              <span className="block text-[13vw] md:text-[7.5vw] 2xl:text-[clamp(4.5rem,7vw,10rem)]"><span className="graphite-rub">02. Cellular</span></span>
              <span className="block text-[13vw] md:text-[7.5vw] 2xl:text-[clamp(4.5rem,7vw,10rem)]"><span className="graphite-rub">Friction</span></span>
            </h2>
          </div>
          <p className="max-w-sm 2xl:max-w-md -rotate-1 font-hand text-2xl 2xl:text-3xl leading-tight text-[#2C2A29]">
        ...
        <div className="mt-10 border-2 border-[#1A1918] bg-[#FBFAF6]/60">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b-2 border-[#1A1918] px-4 py-2 font-mono2 text-[10px] uppercase tracking-[0.25em] 2xl:text-xs">
          ...
          <div className="grid lg:grid-cols-[280px_1fr_300px] 2xl:grid-cols-[360px_1fr_380px]">
            {/* left tags */}
            <div className="hidden flex-col justify-between gap-6 border-r border-[#1A1918]/20 p-5 2xl:p-8 lg:flex">
              <div>
                <p className="font-mono2 text-[10px] uppercase tracking-[0.3em] text-[#4A4743] 2xl:text-xs">Field notes</p>
                <ul className="mt-3 space-y-3 font-hand text-xl 2xl:text-2xl leading-tight text-[#2C2A29]">
                  <li>① stipple the throat — 400 dots/min</li>
                  <li>② veins in 2H, <b>whisper-light</b></li>
                  <li>③ drown the stem in 6B shadow</li>
                </ul>
              </div>
              <div className="border border-dashed border-[#1A1918]/40 p-3 2xl:p-4">
                <p className="font-mono2 text-[10px] uppercase tracking-[0.25em] 2xl:text-xs">⚠ warning</p>
                <p className="mt-1 font-hand text-lg 2xl:text-xl leading-tight">pollen dust migrates if you smudge too lovingly. that's the point.</p>
              </div>
              <div className="font-mono2 text-[10px] uppercase leading-relaxed tracking-[0.2em] text-[#4A4743] 2xl:text-xs">
            ...
            <div
              ...
              data-cursor="smudge"
              className="relative min-h-[480px] overflow-hidden md:min-h-[640px] 2xl:min-h-[780px] 3xl:min-h-[880px]"
            >
              ...
              <p className="absolute bottom-4 right-6 rotate-[-4deg] bg-[#F5F2EB] px-2 py-1 font-hand text-lg 2xl:text-xl leading-none shadow">rub here!!</p>
            </div>

            {/* right copy */}
            <div className="flex flex-col justify-between gap-6 border-t border-[#1A1918]/20 p-5 2xl:p-8 lg:border-l lg:border-t-0">
              <div>
                <p className="font-mono2 text-[10px] uppercase tracking-[0.3em] text-[#4A4743] 2xl:text-xs">Narrative · silver gelatin voice</p>
                <p className="mt-3 font-hand text-[22px] 2xl:text-[26px] leading-[1.3] text-[#2C2A29]">
              ...
              <div className="space-y-2">
                {["petal I — stipple 82%", "petal II — flat wash 64%", "throat — mass 97%"].map((t) => (
                  <div key={t} className="flex items-center justify-between border border-[#1A1918]/25 px-3 py-2 font-mono2 text-[10px] uppercase tracking-[0.2em] 2xl:text-xs">
                    <span>{t}</span><span>●</span>
                  </div>
                ))}
              </div>
              <div className="flex items-end justify-between">
                <div className="font-mono2 text-[10px] uppercase tracking-[0.2em] text-[#4A4743] 2xl:text-xs">Project Manager:<br /><b className="text-[#1A1918]">Dr. E. V. Lead</b></div>
                <StarDoodle className="h-9 w-9 2xl:h-12 2xl:w-12 animate-wobble text-[#1A1918]" />
              </div>
            </div>
          </div>
        </div>

        <p className="mt-6 text-center font-scribble text-xs 2xl:text-sm text-[#4A4743]">* no orchids were vectorized in the making of this chapter — only smudged.</p>
      </div>
    </section>
  );
}
    ...
    <div ref={wrapRef} id="inversion-sensor" className="relative h-[340vh]">
      <div className="sticky top-0 flex h-screen flex-col overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center" style={{ opacity: 1 - p * 1.6 }}>
          <p className="font-mono2 text-[11px] uppercase tracking-[0.45em] text-[#4A4743] 2xl:text-xs">interlude — keep dragging downward</p>
          <h2 className="roughen mt-4 font-display text-[14vw] uppercase leading-[0.85] md:text-[8vw] 2xl:text-[clamp(5rem,7.5vw,11rem)]"><span className="graphite-rub">The great</span></h2>
          <p className="mt-2 font-hand text-3xl 2xl:text-4xl text-[#4A4743]">something heavy is about to happen…</p>
        </div>

        {/* dark wipe */}
        <div className="dark-surface absolute inset-0" style={{ clipPath: `inset(${(1 - p) * 100}% 0 0 0)` }}>
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
            <p className="font-mono2 text-[11px] uppercase tracking-[0.45em] text-[#7E8084] 2xl:text-xs">you are now inside the shadow</p>
            <h2 className="roughen mt-4 font-display uppercase leading-[0.85]">
              <span className="block text-[13vw] md:text-[8vw] 2xl:text-[clamp(5rem,7.5vw,11rem)]"><span className="graphite-rub-light">Smear into</span></span>
              <span className="block text-[13vw] md:text-[8vw] 2xl:text-[clamp(5rem,7.5vw,11rem)]"><span className="graphite-rub-light">Darkness</span></span>
            </h2>
            <p className="mt-4 max-w-md 2xl:max-w-xl font-hand text-2xl 2xl:text-3xl leading-tight text-[#C8D0D8]">velvet charcoal falling like night. pillars waking up below ↓</p>
          </div>
          {/* chalk dust */}
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 mix-blend-difference">
          <div className="flex items-center justify-between px-6 pb-3 font-mono2 text-[10px] uppercase tracking-[0.3em] text-white md:px-10 2xl:px-16 2xl:text-xs">
            <span>{p < 0.45 ? "○ paper world" : "● slate world"}</span>
            <span className="text-2xl 2xl:text-3xl tracking-normal">{Math.round(p * 100)}%</span>
...
export function Chapter03() {
  ...
  return (
    <section id="monoliths" className="dark-surface relative overflow-hidden text-[#E8EAED]">
      ...
      <div className="mx-auto max-w-[min(92vw,2200px)] w-full px-5 py-16 md:px-10 md:py-24 2xl:px-16 2xl:py-32">
        <p className="font-mono2 text-[11px] uppercase tracking-[0.4em] text-[#7E8084] 2xl:text-xs">Chapter 03 — Monolithic silence</p>
        <h2 className="roughen mt-3 font-display uppercase leading-[0.85]">
          <span className="block text-[12vw] md:text-[7.2vw] 2xl:text-[clamp(4.5rem,6.8vw,10rem)]"><span className="graphite-rub-light">03. Architectural</span></span>
          <span className="block text-[12vw] md:text-[7.2vw] 2xl:text-[clamp(4.5rem,6.8vw,10rem)]"><span className="graphite-rub-light">Ruins</span><span className="ml-4 align-middle font-hand text-[5vw] normal-case text-[#7E8084] md:text-[2vw] 2xl:text-[2.6rem]">(shhh… dust sleeps here)</span></span>
        </h2>

        <div ref={ref} className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] 2xl:gap-16">
          <div className="relative overflow-hidden border border-[#E8EAED]/25" data-cursor="drag">
            <img
              ...
              className="h-[480px] w-full object-cover md:h-[640px] 2xl:h-[800px] 3xl:h-[900px]"
            ...
            {/* dimension lines */}
            <div className="absolute left-6 top-6 font-mono2 text-[10px] tracking-[0.25em] text-[#E8EAED]/80 2xl:text-xs">
              <div className="border-x border-t border-[#E8EAED]/50 px-3 py-1">12.4m</div>
            </div>
            <div className="absolute bottom-24 right-8 rotate-90 font-mono2 text-[10px] tracking-[0.25em] text-[#E8EAED]/80 2xl:text-xs">
              <div className="border-x border-t border-[#E8EAED]/50 px-3 py-1">88°</div>
            </div>
            <div className="absolute bottom-0 inset-x-0 flex items-center justify-between bg-gradient-to-t from-black/80 to-transparent p-5 pt-12 font-mono2 text-[10px] 2xl:text-xs uppercase tracking-[0.25em] text-[#E8EAED]/90">
          ...
          <div className="flex flex-col justify-between gap-8">
            <div className="border border-[#E8EAED]/20 bg-white/[0.03] p-6 backdrop-blur-sm md:p-8 2xl:p-12">
              <p className="font-mono2 text-[10px] uppercase tracking-[0.3em] text-[#7E8084] 2xl:text-xs">Narrative · written in silver lead</p>
              <p className="mt-4 font-hand text-[24px] 2xl:text-[28px] leading-[1.35] text-[#E8EAED]">
              ...
              <div className="mt-6 grid grid-cols-3 gap-3 font-mono2 text-center text-[10px] uppercase tracking-[0.2em] 2xl:text-xs">
                {[["98%", "density"], ["4.2g", "dust"], ["9B+", "pressure"]].map(([v, k]) => (
                  <div key={k} className="border border-[#E8EAED]/20 px-2 py-3 2xl:py-4">
                    <div className="text-lg 2xl:text-2xl tracking-normal text-[#E8EAED]">{v}</div>
            ...
            {/* whoops doodle */}
            <div className="relative -rotate-1 border border-dashed border-[#E8EAED]/30 p-5 2xl:p-8">
              <div className="flex items-center gap-5">
                <svg viewBox="0 0 80 90" className="h-20 w-16 2xl:h-24 2xl:w-20 shrink-0 -rotate-12 text-[#E8EAED]" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div>
                  <p className="font-hand text-2xl 2xl:text-3xl leading-tight text-[#E8EAED]">one column fell over…</p>
                  <p className="font-scribble text-xs 2xl:text-sm text-[#7E8084]">whoops. — site foreman ☺</p>
                </div>
                <StarDoodle className="ml-auto h-8 w-8 2xl:h-10 2xl:w-10 animate-wobble text-[#E8EAED]/60" />
              </div>
            </div>

            <a href="#sandbox" data-cursor="draw" onClick={() => graphiteAudio.tap("eraser")} className="group flex items-center justify-between border border-[#E8EAED]/40 px-6 py-5 2xl:px-8 2xl:py-6 font-mono2 text-[11px] 2xl:text-xs uppercase tracking-[0.3em] transition-all hover:bg-[#E8EAED] hover:text-[#0D0D0E]">
